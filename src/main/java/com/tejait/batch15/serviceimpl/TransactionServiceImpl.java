...
public class TransactionServiceImpl implements TransactionService {
    ...
    public synchronized void uploadCsv(Integer appId, MultipartFile file) {
        ...
        try {
            ...
            // 🔥 STEP 3: Parse CSV
            List<Transaction> list = parseCsv(file, appId);
    ...
    @Override
    @Transactional
    public synchronized void saveAll(Integer appId, List<Transaction> list) {
    ...
    @Override
    public List<Transaction> getAllByAppId(Integer appId) {
    ...
    private List<Transaction> parseCsv(MultipartFile file, Integer appId) {
